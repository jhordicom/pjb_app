        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{route('simpan-workshop')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="">JUDUL PROGRAM</label>
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="text" id="nama_workshop" name="nama_workshop" class="form-control select2" style="width: 100%" placeholder="Judul Program" selected="selected">
                                    </input>
                                </div>
                            </div>
                            <div class="form-group">
